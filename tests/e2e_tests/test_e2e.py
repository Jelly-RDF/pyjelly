...
class End2EndOptionSetup:
    ...
    def setup_triple_files(self) -> list[tuple[BaseSerDes, BaseSerDes, StreamOptions, int, Path]]:
        ...
        return [(*o, f) for o in options for f in files]
        

    def setup_quad_files(self) -> list[tuple[BaseSerDes, BaseSerDes, StreamOptions, int, Path]]:
...
class TestEnd2End:
    ...
    @pytest.mark.parametrize(("ser", "des", "options", "frame_size", "file"), setup.setup_triple_files())
    ...
    @pytest.mark.parametrize(("ser", "des", "options", "frame_size", "file"), setup.setup_quad_files())
    def test_quad_files(
        self,
        ser: BaseSerDes,
        des: BaseSerDes,
