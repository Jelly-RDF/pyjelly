...
from pyjelly._serializing import frames, lookups
...
class StatementEncoder(metaclass=ABCMeta):
    ...
    def encode_options(self, *, frame_logic: frames.FrameLogic) -> None:
        """
    ...
    def cycle(self, frame_logic: frames.FrameLogic) -> pb.RdfStreamFrame | None:
        """
